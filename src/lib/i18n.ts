...
const en = {
  ...
  selectedDayTimes: "Available times on {date}",
  detailsHeading: "Your details for {when}",
...
const fr: Record<MessageKey, string> = {
  ...
  selectedDayTimes: "Heures disponibles le {date}",
  detailsHeading: "Vos coordonnées pour {when}",
