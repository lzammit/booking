...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        // LSUIElement apps have no menu bar, so ⌘V/⌘C/⌘X/⌘A have nothing to
        // route to and pasting into the Settings dialog fails. A hidden main
        // menu with the standard Edit actions restores the shortcuts.
        let mainMenu = NSMenu()
